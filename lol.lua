--Wanna sex babe - Krnl support by Disc_#7798
local env = getgenv()
	...
	table.insert(cors, sandbox(LocalScript659, function()
		...
		local u2 = coroutine.create(function()
			...
			sN.Stepped:Connect(function()
				...
				if script.Parent.Parent.movementcorrect.Selection.Text == "Manual" or script.Parent.Parent.movementcorrect.Selection.Text == "Automatic" or script.Parent.Parent.movementcorrect.Selection.Text == "Test" then
