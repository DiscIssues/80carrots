...
"You know, I`m actually terrible at flirting. How about you try to pick me up instead?"
	...
	local cfglocation = "catto.momentum/" 
	makefolder("catto.momentum") 
...
local function YDQUIX_fake_script() -- TextLabel.LocalScript 
	...
	if plr then
		script.Parent.Text = "    Catto.Momentum  -  "..plr.Name..""
	end
end
...
chat:Element("Dropdown", "type", {options = {"Effort", "VoidClient", "Flirt"}})
